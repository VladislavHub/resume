...
var header = {
  ...
  salary: '600$ в місяць',
  address: 'вул. Хрещатик, 36, м. Київ, 01044',
}
  ...
  res.render('education', {
    ...
    main: {
      education: [
        ...
        {
          name: 'Національний медичний університет',
          isEnd: true,
        },
        {
          ...
          projects: [
            {
              ...
              about:
                'Airbn competitor. Hihg-load application for searching apastments',
              stacks: [
                {
                  name: 'React.js',
                },
              ...
              awards: [
                {
                  name: 'Background verification - is a feature that ptovides users to prove that thay are real persons',
                },
                {
